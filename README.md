...
<i>"Mühendislik; karmaşık problemleri veri ve algoritma ile çözme sanatıdır."</i>
...
Fırat Üniversitesi **Yapay Zeka ve Veri Mühendisliği** bölümünde lisans eğitimime devam ediyorum. 
...
Öğrenim hayatım ve projelerim boyunca kullandığım teknoloji yığınım:
...
| **Veri & AI** | Veri Madenciliği, NLP (Doğal Dil İşleme), Algoritma Analizi, Veri Yapıları |
| **Sistem & Backend** | Gömülü Sistemler (IoT), İlişkisel Veritabanı Tasarımı (RDBMS), Backend Mimarisi |
| **Araçlar** | Git/GitHub, Linux İşletim Sistemi, VS Code, MS Office |
